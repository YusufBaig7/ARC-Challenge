...
with open("/scratch/yb2510/ARC/deepseek_first_finetune_3_epoch/qa_dataset.pkl" ,"rb") as f:
...
model.save_pretrained("/scratch/yb2510/ARC/deepseek_first_finetune_3_epoch/shrunk_model_dir")
tokenizer.save_pretrained("/scratch/yb2510/ARC/deepseek_first_finetune_3_epoch/shrunk_model_dir")
...
training_args = TrainingArguments(
    ...
    learning_rate               = 1e-5,
    num_train_epochs            = 3,
    output_dir                  = "/scratch/yb2510/deepseek_r1_lora_14B_3_epoch",
    max_grad_norm=1.0,
    save_strategy      = "epoch",
    logging_steps      = 1,
