...
tokenizer = AutoTokenizer.from_pretrained("/scratch/yb2510/ARC/transduction/shrunk_model_dir", trust_remote_code=True, use_fast=False)
...
merged_model.save_pretrained("/scratch/yb2510/ARC/transduction/merged_aug/", safe_serialization=True)
tokenizer.save_pretrained("/scratch/yb2510/ARC/transduction/merged_aug/")
